...
namespace ParcnuAPI.AddCustomer
{
    public static class AddCustomer
    {
        [FunctionName(ParcnuEnums.FunctionName.AddCustomer)]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = ParcnuEnums.FunctionName.AddCustomer)] HttpRequest req,
            [Table(ParcnuEnums.DatabaseName.Customers, Connection = "AzureWebJobsStorage")] IAsyncCollector<ParcnuCustomerDataDS> customerTableCollector,
            ILogger log)
        {
            ...
            CloudTable table = client.GetTableReference(ParcnuEnums.DatabaseName.Customers);
